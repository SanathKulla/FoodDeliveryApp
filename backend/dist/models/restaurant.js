...
const menuItemSchema = new mongoose_1.default.Schema({
    _id: { type: mongoose_1.default.Schema.Types.ObjectId, required: true, default: () => new mongoose_1.default.Types.ObjectId() }, // this is done to access id when type is referened
...
const restaurantSchema = new mongoose_1.default.Schema({
    ...
    user: { type: mongoose_1.default.Schema.Types.ObjectId, ref: "User" }, //user objectid is _id of user in User collection
